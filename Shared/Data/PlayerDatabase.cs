...
public static class PlayerDatabase
{
    ...
    private static List<Player> Build()
    {
        ...
        var l = new List<Player>
        {
            ...
            P("Rivaldo", "Brasil", BR, Position.MID, 89, 2002, true),
            P("Zico", "Brasil", BR, Position.MID, 90, 1982, true),
            P("Sócrates", "Brasil", BR, Position.MID, 88, 1982, true),
            P("Kaká", "Brasil", BR, Position.MID, 89, 2006, true),
            P("Neymar", "Brasil", BR, Position.FWD, 90, 2018, true),
            P("Roberto Carlos", "Brasil", BR, Position.DEF, 88, 2002, true),
            P("Cafú", "Brasil", BR, Position.DEF, 87, 2002, true),
            ...
            P("Gabriel Batistuta", "Argentina", AR, Position.FWD, 89, 1998, true),
            P("Daniel Passarella", "Argentina", AR, Position.DEF, 86, 1978),
            ...
            P("Ubaldo Fillol", "Argentina", AR, Position.GK, 84, 1978),
            ...
            P("Lothar Matthäus", "Alemania", DE, Position.MID, 89, 1990, true),
            P("Miroslav Klose", "Alemania", DE, Position.FWD, 87, 2014, true),
            P("Oliver Kahn", "Alemania", DE, Position.GK, 89, 2002, true),
            P("Manuel Neuer", "Alemania", DE, Position.GK, 90, 2014, true),
            ...
            P("Edwin van der Sar", "P. Bajos", NL, Position.GK, 85, 2010),
            P("Ronald Koeman", "P. Bajos", NL, Position.DEF, 84, 1994),

            // ---------- ITALIA ----------
            P("Roberto Baggio", "Italia", IT, Position.FWD, 91, 1994, true),
            P("Paolo Maldini", "Italia", IT, Position.DEF, 91, 1994, true),
            P("Franco Baresi", "Italia", IT, Position.DEF, 89, 1994, true),
            P("Dino Zoff", "Italia", IT, Position.GK, 88, 1982, true),
            ...
            P("Fabio Cannavaro", "Italia", IT, Position.DEF, 89, 2006, true),
            P("Gianluigi Buffon", "Italia", IT, Position.GK, 90, 2006, true),
            P("Andrea Pirlo", "Italia", IT, Position.MID, 89, 2012, true),
            P("Alessandro Nesta", "Italia", IT, Position.DEF, 87, 2006),
            P("Giacinto Facchetti", "Italia", IT, Position.DEF, 85, 1970),
            ...
            P("Bobby Moore", "Inglaterra", EN, Position.DEF, 89, 1966, true),
            P("Gordon Banks", "Inglaterra", EN, Position.GK, 86, 1966),
            ...
            P("Iker Casillas", "España", ES, Position.GK, 89, 2010, true),
            ...
            // ---------- OTRAS ESTRELLAS ----------
            P("Luka Modrić", "Croacia", HR, Position.MID, 89, 2018, true),
            ...
            P("Thibaut Courtois", "Bélgica", BE, Position.GK, 88, 2018, true),
            ...
            P("Peter Schmeichel", "Dinamarca", DK, Position.GK, 86, 1998),
            ...
            P("Lev Yashin", "Rusia", RU, Position.GK, 90, 1966, true),
            P("Andriy Shevchenko", "Ucrania", UA, Position.FWD, 87, 2006, true),
