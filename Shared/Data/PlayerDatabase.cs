...
public static class PlayerDatabase
{
    ...
    private static List<Player> Build()
    {
        ...
        var l = new List<Player>
        {
            ...
            P("Raúl González", "España", ES, Position.FWD, 88, 2002, true),
        ...
        l.AddRange(new[]
        {
            ...
            P("Ruud Krol", "P. Bajos", NL, Position.DEF, 89, 1974, true),
            ...
            P("Jaap Stam", "P. Bajos", NL, Position.DEF, 87, 1998, true),
            ...
            P("Clarence Seedorf", "P. Bajos", NL, Position.MID, 88, 2000, true),
            ...
            P("Edgar Davids", "P. Bajos", NL, Position.MID, 86, 1998, true),
            ...
            P("Vinícius Júnior", "Brasil", BR, Position.FWD, 90, 2026, true),
